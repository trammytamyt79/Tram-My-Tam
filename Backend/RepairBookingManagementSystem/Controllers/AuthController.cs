...
using AutoMapper;
using RepairBookingManagementSystem.Configurations;
...
using LoginRequest = RepairBookingManagementSystem.Dtos.LoginRequest;
using RegisterRequest = RepairBookingManagementSystem.Dtos.RegisterRequest;
